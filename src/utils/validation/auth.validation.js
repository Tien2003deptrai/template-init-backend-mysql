...
async function validateGoogleSignup(req, res, next) {
  try {
    ...
    if (
      !req.body.hasOwnProperty('google_first_name') ||
      req.body.google_first_name === ''
    ) {
      errors['google_first_name'] = 'Please enter first name';
    }
    if (
      !req.body.hasOwnProperty('google_last_name') ||
      req.body.google_last_name === ''
    ) {
      errors['google_last_name'] = 'Please enter last name';
    }
    if (
      !req.body.hasOwnProperty('google_email') ||
